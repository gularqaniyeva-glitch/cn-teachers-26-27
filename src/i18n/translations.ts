...
export const TRANSLATIONS: Record<Locale, Dict> = {
  ru: {
    ...
    dashboard: {
      ...
      enteredTooltip: 'Количество и процент учителей, совершивших хотя бы один вход в LMS (прямой подсчёт по листу «Все учителя 26/27»).',
      notEnteredTooltip: 'Количество и процент учителей, пока не активировавших профиль — ни разу не заходивших на платформу.',
    ...
    statistics: {
      ...
      kpiPlatformActivityTooltip: 'Доля учителей, совершивших хотя бы один вход в LMS — прямой подсчёт по листу «Все учителя 26/27».',
  ...
  az: {
    ...
    dashboard: {
      ...
      enteredTooltip: 'Ən azı bir dəfə LMS-ə daxil olmuş müəllimlərin sayı və faizi ("Bütün müəllimlər 26/27" vərəqinə əsasən birbaşa hesablama).',
      notEnteredTooltip: 'Hələ profilini aktivləşdirməmiş — platformaya heç vaxt daxil olmayan müəllimlərin sayı və faizi.',
    ...
    statistics: {
      ...
      kpiPlatformActivityTooltip: '"Bütün müəllimlər 26/27" vərəqinə əsasən birbaşa hesablama — LMS-ə ən azı bir dəfə daxil olmuş müəllimlərin payı.',
